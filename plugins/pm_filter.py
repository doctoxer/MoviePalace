...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('ɪ ʜᴀᴠᴇ ꜱᴇɴᴅ ᴍᴏᴠɪᴇ ᴘᴇʀꜱᴏɴᴀʟʟʏ, ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇʀᴇ ;)', show_alert=True)
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("ɪ ʟɪᴋᴇ ʏᴏᴜʀ ꜱᴍᴀʀᴛɴᴇꜱꜱ, ʙᴜᴛ ᴅᴏɴ'ᴛ ʙᴇ ᴏᴠᴇʀꜱᴍᴀʀᴛ ᴏᴋᴀʏ (oꆤ︵ꆤo)", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        buttons = [[
            ...
            InlineKeyboardButton(text="✪𝖲𝗍𝗂𝖼𝗄𝖾✪𝗋", callback_data="stick"),
            ...
            InlineKeyboardButton(text="✂️𝖱𝖾𝗆𝗈𝗏𝖾 𝖡𝖦✂️", callback_data="removebg")
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('❖︎𝙼𝙰𝙽𝚄𝙴𝙻 𝙵𝙸𝙻𝚃𝙴𝚁❖︎', callback_data='manuelfilter'),
            InlineKeyboardButton('❖︎𝙰𝚄𝚃𝙾 𝙵𝙸𝙻𝚃𝙴𝚁❖︎', callback_data='autofilter'),
            InlineKeyboardButton('❖︎𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙾𝙽𝚂❖︎', callback_data='coct')
            ],[
            InlineKeyboardButton('❖︎𝚂𝙾𝙽𝙶❖︎', callback_data='songs'),
            InlineKeyboardButton('❖︎𝙴𝚇𝚃𝚁𝙰❖︎', callback_data='extra'),
            InlineKeyboardButton("❖︎𝚅𝙸𝙳𝙴𝙾❖︎", callback_data='video')
            ],[
            InlineKeyboardButton('⚚ 𝙱𝙰𝙲𝙺 ⚚', callback_data='start'),
            InlineKeyboardButton('𝕯𝖔𝖚𝖇𝖙..?', url='https://t.me/AjayGhali_TG'),
            InlineKeyboardButton("⚚ NEXT ⚚", callback_data='maravazha')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
        await query.message.edit_text(        
            text="αмαℓ мαтнєω!",
    ...
    elif query.data == "maravazha":
        buttons = [[
            InlineKeyboardButton('❖︎𝙿𝙸𝙽❖︎', callback_data='pin'), 
            InlineKeyboardButton('❖︎𝙿𝙰𝚂𝚃𝙴❖︎', callback_data='pastes'),
            InlineKeyboardButton("❖︎𝙸𝙼𝙰𝙶𝙴❖︎", callback_data='image')
            ],[
            InlineKeyboardButton('❖︎𝙵𝚄𝙽❖︎', callback_data='fun'), 
            InlineKeyboardButton('❖︎𝙹𝚂𝙾𝙽𝙴❖︎', callback_data='son'),
            InlineKeyboardButton('❖︎𝚃𝚃𝚂❖︎', callback_data='ttss')
            ],[
            InlineKeyboardButton('❖︎𝙿𝚄𝚁𝙶𝙴❖︎', callback_data='purges'),
            InlineKeyboardButton('❖︎𝙿𝙸𝙽𝙶❖︎', callback_data='pings'),
            InlineKeyboardButton('❖︎𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙿𝙷❖︎', callback_data='tele')
            ],[
            InlineKeyboardButton('⚚ 𝙱𝙰𝙲𝙺 ⚚', callback_data='help'),
            InlineKeyboardButton('❖︎𝙼𝙾𝚁𝙴❖︎', callback_data='chavar'),
            InlineKeyboardButton("⚚ NEXT ⚚", callback_data='maravazhakal')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)        
        await query.message.edit_text(        
            text="αмαℓ мαтнєω!",
    ...
    elif query.data == "maravazhakal":
        buttons = [[
            InlineKeyboardButton('❖︎𝚆𝙷𝙾𝙸𝚂❖︎', callback_data='whois'),
            InlineKeyboardButton('❖︎𝚈𝚃-𝚃𝙷𝚄𝙼𝙱❖︎', callback_data='ytthumb'),
            InlineKeyboardButton('❖︎𝚂𝚃𝙸𝙲𝙺𝙴𝚁-𝙸𝙳❖︎', callback_data='sticker')
            ],[
            InlineKeyboardButton('❖︎𝙲𝙾𝚅𝙸𝙳❖︎', callback_data='corona'),
            InlineKeyboardButton('❖︎𝙰𝚄𝙳𝙸𝙾-𝙱𝙾𝙾𝙺❖︎', callback_data='abook'),
            InlineKeyboardButton('❖︎𝙶-𝚃𝚁𝙰𝙽𝚂❖︎', callback_data='gtrans')
            ],[
            InlineKeyboardButton('⚚ 𝙱𝙰𝙲𝙺 ⚚', callback_data='maravazha'),
            InlineKeyboardButton('❖︎𝚂𝚃𝙰𝚃𝚄𝚂❖︎', callback_data='stats'),
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ♥️', url='https://t.me/mpd_grp/19')
            ],[
            InlineKeyboardButton('🏠 𝙷𝙾𝙼𝙴 🏠', callback_data='start'),
    ...
    elif query.data == "chavar":
        buttons= [[
            InlineKeyboardButton('↫ 𝙱𝙰𝙲𝙺', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.CHAVAR_TXT.format(temp.B_NAME),
            disable_web_page_preview=True,
            reply_markup=reply_markup,
            parse_mode='html'
        )
